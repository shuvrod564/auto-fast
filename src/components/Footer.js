...
const Footer = () => {
  return (
    <footer className='bg-black pb-5 pt-6'>
      <div className="container flex flex-wrap flex-col sm:flex-row gap-x-3 gap-y-5 items-center justify-between">
        <Link href={'/'} className='inline-block'>
            <Image src={'/auto-fast-logo.webp'} width={150} height={40} alt='logo' style={{filter: 'contrast(0) brightness(10)'}} />
        </Link>
        <ul className="inline-flex">
            <li className='mr-4 md:mr-5'><Link href={'/privacy'} className='text-white'>Privacy Policy</Link></li>
